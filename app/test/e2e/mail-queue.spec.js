...
describe("MailQueue ", function () {
  ...
  it("Test fires-notification-en message received triggers emails sent", async function () {
    ...
    nock("https://api.sparkpost.com")
      .post(`/api/v1/transmissions`, {
        substitution_data: {
          ...
          alert_link:
            "http://staging.globalforestwatch.org/map/3/0/0/ALL/grayscale/viirs_fires_alerts?begin=2019-04-17&end=2019-04-18&fit_to_geom=true&geostore=agpzfmdmdy1hcGlzchULEghHZW9zdG9yZRiAgIDIjJfRCAw",
